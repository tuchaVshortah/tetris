...
link:
	g++ output/tetris.o output/tetrisLogic.o output/main.o -o output/sfml-tetris -L/usr/lib -lsfml-graphics -lsfml-window -lsfml-system -lsfml-network -lsfml-audio
